#!/bin/bash
#title: 16S processing with Qiime2(DADA2)
#The sequence data is a set of Novaseq-sequenced single-end fastq files. 
#primer: V4: 515F-909R GTGCCAGCMGCCGCGGTAA-CCCCGYCAATTCMTTTRAGT

# Activate Qiime2 environment
source /usr/local/miniconda3/etc/profile.d/conda.sh
conda activate qiime2-2023.2

# Set path and sequence of primers
SEQ="/home/16S_rawdata"
OUT="/home/16S"
...
time qiime dada2 denoise-single \
    ...
    --o-table $OUT/dada2/bac_count.qza \
    --o-representative-sequences $OUT/dada2/bac_rep_seqs.qza \
    --verbose
...
time qiime feature-table summarize \
    --i-table $OUT/dada2/bac_count.qza \
    --o-visualization $OUT/dada2/bac_count.qzv
## representative sequences
time qiime feature-table tabulate-seqs \
    --i-data $OUT/dada2/bac_rep_seqs.qza \
    --o-visualization $OUT/dada2/bac_rep_seqs.qzv

# Assign taxonomy
## self-trained Silva Naive Bayes classifier
mkdir $OUT/classified_sequences
time qiime feature-classifier classify-sklearn \
    --i-classifier $DATABASE/silva-138.1-ssu-nr99-classifier.qza \
    --i-reads $OUT/dada2/bac_rep_seqs.qza \
...
time qiime metadata tabulate \
    --m-input-file $OUT/dada2/stats-dada2.qza \
...
mv $OUT/final_export/taxonomy.tsv $OUT/final_export/bac_taxonomy.tsv
## feature table 
qiime tools export \
    --input-path $OUT/dada2/bac_count.qza \
    --output-path $OUT/final_export
biom convert \
    -i $OUT/final_export/feature-table.biom \
    -o $OUT/final_export/bac_count.txt \
    --to-tsv
